define("control/phoneList",function(require, exports, module) {
	var page={};
	module.exports=page;
	page.par=[];
	...
	page.fn=function(data){
		...
		/*加载头部，传入参数*/
		view.head.show("head_template",{"left":{type:"back",text:"返回"},"center":{type:"title",text:"电话黄页"},"right":{type:"button",text:"最近拨打"}},headDone);
		/*隐藏脚部*/
